#setwd("C:/Users/user/Dropbox (UFL)/2nd project/code/simulation/Gr2")
...
save(mat, file=paste("/home/nchakraborty/2nd/sim_gr2/s1_n=300/sig_0.1",
                     "/res_0.1/metric_test-", index, ".dat", sep=''))
save(data, file=paste("/home/nchakraborty/2nd/sim_gr2/s1_n=300/sig_0.1",
                      "/res_0.1/data_test-", index, ".dat", sep=''))
save(forecast_true, file=paste("/home/nchakraborty/2nd/sim_gr2/s1_n=300/sig_0.1",
                              "/res_0.1/ftrue_test-", index, ".dat", sep=''))

save(A_true, file=paste("/home/nchakraborty/2nd/sim_gr2/s1_n=300/sig_0.1",
                        "/res_0.1/A_true_test-", index, ".dat", sep=''))
save(w_true, file=paste("/home/nchakraborty/2nd/sim_gr2/s1_n=300/sig_0.1",
                        "/res_0.1/w_true_test-", index, ".dat", sep=''))
save(A_final, file=paste("/home/nchakraborty/2nd/sim_gr2/s1_n=300/sig_0.1",
                         "/res_0.1/A_est_test-", index, ".dat", sep=''))
save(w_final, file=paste("/home/nchakraborty/2nd/sim_gr2/s1_n=300/sig_0.1",
                         "/res_0.1//w_est_test-", index, ".dat", sep=''))
save(sigma_true, file=paste("/home/nchakraborty/2nd/sim_gr2/s1_n=300/sig_0.1",
                            "/res_0.1/sigma_true_test-", index, ".dat", sep=''))
save(sigma_final, file=paste("/home/nchakraborty/2nd/sim_gr2/s1_n=300/sig_0.1",
                             "/res_0.1/sigma_est_test-", index, ".dat", sep=''))
save(theta_final, file=paste("/home/nchakraborty/2nd/sim_gr2/s1_n=300/sig_0.1",
                             "/res_0.1/theta_est_test-", index, ".dat", sep=''))
save(crps_mat, file=paste("/home/nchakraborty/2nd/sim_gr2/s1_n=300/sig_0.1",
                          "/res_0.1/crps_mat_test-", index, ".dat", sep=''))
save(logs_mat, file=paste("/home/nchakraborty/2nd/sim_gr2/s1_n=300/sig_0.1",
                          "/res_0.1/logs_mat_test-", index, ".dat", sep=''))
save(ferr_med_low, file=paste("/home/nchakraborty/2nd/sim_gr2/s1_n=300/sig_0.1",
